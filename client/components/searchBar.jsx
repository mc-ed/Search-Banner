      ...
      <div className={`${style['search-wrap']}`}>
        <form className={`form-group ${style['form-group-adjust']}`}>
          <div className={`row ${style['row-adjust']} d-flex dropdown`}>
            ...
            >
              <div className={`${style['search-icon']} ${style['lowes-icon']}`}>
                {'\uEB30'}
              </div>
            </div>
            ...
            >
              <div className={`row ${style['row-adjust']}`}>
                <div
                  className={`col-3 ${style['search-item']} ${
                    style.scrollbar
                  } ${style['destroy-padding-left']} ${
                    style['destroy-adding-right']
                  }`}
                >
                            ...
                            onClick={() => {
                              ...
                              window.dispatchEvent(
                                new CustomEvent('product', {
                                  detail: {
                                    product_id: props.suggestionList[0].id
                                  }
                                })
                              );
                              props.clearSearch();
                ...
                <div
                  className={`col-md-12 col-lg-9 ${style['padding-adjust']} ${
                    style.scrollbar
                  }`}
                >
                  <div className={`${style['product-suggestion']}`}>
                    Product Suggestions
                  </div>
